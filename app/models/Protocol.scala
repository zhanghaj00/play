...
object Protocol {
  ...
  lazy val roomManager: ActorRef = system.actorSelection("akka://application/user/rooms")
  lazy val userManager: ActorRef = system.actorSelection("akka://application/user/users")
